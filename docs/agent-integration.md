...
Browser operations return `capability_unavailable` until the protected runtime and qualified adapter are connected. Production VM enrollment and live subscription authentication remain unqualified.
