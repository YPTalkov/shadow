...
| U8 | In progress | Shared request/result contracts, native API, CLI/MCP/PTC parity (29 tests), native authority tests and actual Linux Codex MCP pass. Completing host ChatGPT authentication and production agent VM controls, then protected source jobs. |
