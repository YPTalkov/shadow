...
CHECKS = ("AGENT_CODEX_SHELL_MCP", "AGENT_ROOT_BOUNDARY", "AGENT_TASK_TEARDOWN", "AGENT_LOCK_REJECTS_OLD_BOOT", "AGENT_RUNTIME")
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=IMAGE / "results.json")
    arguments = parser.parse_args()
    binary, image = arguments.binary.resolve(), arguments.image.resolve()
    results = []
